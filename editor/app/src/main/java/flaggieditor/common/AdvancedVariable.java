...
public class AdvancedVariable<T> {
    ...
    private AdvancedVariable() {
        ...
        this.objectWriter = this.objectMapper.writer(new CustomPrettyPrinter());
    }
    ...
    public void printJsonData() throws JsonProcessingException {
        System.out.println(this.objectWriter.writeValueAsString(this.storedValue));
    }
